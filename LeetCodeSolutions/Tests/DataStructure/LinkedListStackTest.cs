...
namespace LeetCodeSolutions.Tests.DataStructure
{
	...
	{
		[Fact]
		public void LinkedListStack_InitTest()
		{
			LinkedListStack<TestModel> test = new();
		...
		[Fact]
		public void LinkedListStack_PushTest()
		{
			LinkedListStack<TestModel> test = new();
		...
		[Fact]
		public void LinkedListStack_PopTest()
		{
			LinkedListStack<TestModel> test = new();
			bool exceptedBool = false;
			int exceptedValue = 1;
		...
		[Fact]
		public void LinkedListStack_PeekTest()
		{
			LinkedListStack<TestModel> test = new();
			bool exceptedBool = false;
			int exceptedValue = 1;
